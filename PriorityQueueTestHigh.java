...
Descrtn: Priority Queue of Tasks where HIGH priority values = HIGH priority.
...
public class PriorityQueueTestHigh
{
   public static void main (String[] args)
   {
      PriorityQueue<Task> tasks = new PriorityQueue<Task>();

      tasks.add (new Task (10, "Buy a Quadbike") );
      tasks.add (new Task (9, "Buy health insurance") );
      tasks.add (new Task (5, "Learn tricks on Quadbike") );
      tasks.add (new Task (1, "Jump Quadbike over cars") );
